...
let otherProjects: [LinkedResource] = [
  LinkedResource(
    title: "Ouira",
    href: "https://ouira.vercel.app/",
    description: "My company. Crafting meaningful products that quietly enhance everyday life."
  ),
  LinkedResource(
    title: "Life lessons",
    href: "/life-lessons/",
    description: "A growing collection of things I\u{2019}ve learned along the way."
  ),
  LinkedResource(
    title: "Quitting social media",
    href: "/quitting-social-media/",
    description: "Notes on my slow, work-in-progress path away from social media."
  ),
]
